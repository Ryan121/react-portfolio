...
import FooterLogo from 'assets/logo/default.svg';
      ...
      <Container>
        ...
        <Box sx={styles.footer.footerBottomArea}>
          ...
          <Text sx={styles.footer.copyright}>
            Copyright by {new Date().getFullYear()}, Ryan Sers
          </Text>
        </Box>
      </Container>
    </footer>
...
const styles = {
  footer: {
    imageBox: {
      ...
      display: 'flex',
      height: '25rem',
      mt: [0, null, -30, null, null, '-40px', null, -3],
      mb: [0, null, -120, null, null, '-40px', null, -3],
      img: {
        // position: 'relative',
        // height: [245, 'auto'],
      },
